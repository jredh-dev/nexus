...
//	@title          nexus-vn API
//	@version        1.0
//	@description    Visual novel engine with branching narrative, chapter-based progression, voting, and video streaming.
//	@host           localhost:8080
//	@BasePath       /
...
// Generated by: swag init --v2 --generalInfo services/vn/cmd/server/main.go --output services/vn/cmd/server/docs
//
