...
//   - Agent files (AGENTS.md, *.AGENTS.md) bypass the quiet-period entirely and
...
func (w *Watcher) handleEvent(event fsnotify.Event) {
	...
	// Agent files (AGENTS.md, *.AGENTS.md) bypass the quiet-period entirely
	...
	if filter.IsAgentsFile(rel) {
		slog.Debug("watcher: agent file changed — emitting immediately", "path", rel)
		select {
